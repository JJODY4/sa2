...
extern void SA2_LABEL(SetWindowRegionExtended)(u8 param0, int_vcount minY, int_vcount maxY, u16 param3, u16 param4);
extern void SA2_LABEL(SetWindowRegion)(u8 bg, int_vcount minY, int_vcount maxY, u16 offsetEven, u16 offsetOdd);
